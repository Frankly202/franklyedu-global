...
export const Route = createFileRoute("/login")({
  head: () => pageMeta("Login", "Sign in to your FranklyEdu student account to track applications and saved universities."),
  component: LoginPage,
});
  ...
  return (
    <section className="bg-navy-deep py-16 text-navy-foreground sm:py-24">
      <div className="container-site max-w-2xl text-center">
        ...
        <p className="mt-4 text-navy-muted">Student account access will be connected here when the application system is ready.</p>
      </div>
      <form
      ...
      >
        <div className="card-navy grid gap-3 p-6">
          ...
          <button type="button" className="text-left text-sm hover:underline">Forgot password?</button>
          <button type="submit" className="btn btn-primary btn-lg">Log in (integration ready)</button>
          <p className="text-sm">
